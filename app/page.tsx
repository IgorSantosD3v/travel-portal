      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <h1 className={styles.title}>
            Descubra o mundo <em>com o</em> ViajaJá
          </h1>
          <p className={styles.subtitle}>
            Seu portal de viagens para conhecer destinos incríveis ao redor
            do planeta. Explore praias paradisíacas, cidades históricas e
